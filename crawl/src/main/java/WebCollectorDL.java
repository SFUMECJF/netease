...
public class WebCollectorDL extends BreadthCrawler {
    ...
    public static final String CRAWLURL = "https://subhd.tv/a/514541";
    // 种子页面CRAWLURL里面的网页会符合什么标准，比如这个，每一章都类似，c1,c2,c3,c……所以最后用了一个%d，之后迭代这个页面的时候，可以直接用循环变量i替换
    public static final String PAGEURL = "https://subhd.tv/a/514541";
    //循环的开始和结束变量
    ...
    public static final String REGEXURL = "https://dl.subhd.la/*";

    public WebCollectorDL(String crawlPath, boolean autoParse) {
        /**
    ...
    public static void main(String[] args) {
        ...
        WebControllerTest webControllerTest = new WebControllerTest("WebControllerDL", true);
        try {
            //设置爬取的线程数
            webControllerTest.setThreads(50);
            //设置每次迭代爬取的网页数量上限
            //webControllerTest.setTopN(100);
            webControllerTest.getConf().setTopN(500);
            //爬取的深度
            webControllerTest.start(2);
        } catch (Exception e) {
            e.printStackTrace();
        }
